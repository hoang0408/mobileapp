...
stop.addEventListener("click",
  function() {
    ...
    // if( 9999<stopTime&& stopTime<11000){
    //   if( soundEndflag === "1"){
    //     soundControl("end","");
    //   }
    ...
    //     soundControl("end","");
    //   }
    //   let resultSound = "sound/stop1.mp3";
    //   w_sound = resultSound;
    //     soundControl("start", w_sound);
    //     soundEndflag = "1";
    // }
    ...
    if(top5_flg==="1"){
      ...
      const fireworks= document.getElementsByClassName("body");
